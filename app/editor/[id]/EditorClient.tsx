...
export default function EditorClient({ challengeId, initialChallenge }: EditorClientProps) {
  ...
  // Load Pyodide directly from CDN (skip npm import which is not browser-compatible)
  useEffect(() => {
    let isMounted = true;
  ...
  // Fetch user progress and profile (user-specific data)
  useEffect(() => {
    ...
    fetchUserData();
  }, [challengeId, challenge.starter_code, supabase]);
      ...
      <main className="pt-16 h-screen flex overflow-hidden">
        ...
        <div className="lg:ml-64 flex-1 flex flex-col lg:flex-row bg-surface overflow-hidden">
          ...
          <section className="flex-1 flex flex-col p-4 lg:p-6 overflow-hidden">
            ...
            {/* Code Canvas — Monaco always shown; Pyodide loads in background */}
